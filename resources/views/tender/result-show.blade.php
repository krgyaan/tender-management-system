@extends('layouts.app')
@section('page-title', 'Tender Result View')
            ...
            <div class="card m-auto">
                <div class="card-body" id="print">
                    ...
                    <div class="result mt-5">
                        <div class="text-center fw-bold">
                            <h5 class="mt-5 mb-0">Tender Result Data</h5>
                        </div>
                        @if($tender->result)
                                ...
                                <table class="table-bordered w-100">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{ $tender->result->qualified_parties_count }}</td>
                                            <th>Screenshot of Qualified Parties</th>
                                            <td>
                                                @if($tender->result->qualified_parties_screenshot)
                                                    @php
                                                        $data = json_decode($tender->result->qualified_parties_screenshot, true);
                                                    @endphp
                                                    @foreach($data as $item)
                                                        <a href="{{ asset('uploads/tender-results/' . $item) }}" target="_blank">
                                                            View File {{ $loop->iteration }}<br>
                                                        </a>
                                                    @endforeach
                                                @else
                                                    Not Uploaded
                                        ...
                                        <tr>
                                            <th>Result: L1 Price</th>
                                            <td>{{ $tender->result->l1_price }}</td>
                                            <th>Screenshot of the Final result</th>
                                            <td>
                                                @if($tender->result->final_result)
                                                    <a href="{{ asset('uploads/tender-results/' . $tender->result->final_result) }}" target="_blank">
                                                        View File        
                                                    </a>
                                                @else
                                                    Not Uploaded
