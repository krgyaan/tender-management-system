@extends('layouts.app')
@section('page-title', 'Battery Installation')
@section('content')
<section>
    <div class="row">
        <div class="col-xl-4">
            <div class="card">
                <div class="card-header px-2 py-2 text-capitalize ">
                    <h6 class="mb-0">Battery Installation Add</h6>
                </div>
                <div class="card-body p-4">
                    <form class="row g-3 needs-validation" id="formatDistrict-update" method="POST"
                        action="{{ asset('admin/batteryinstallationadd') }}" novalidate>
                        @csrf
                        <div class="col-md-12">
                            <label for="Vehicletitle" class="form-label">Title <span
        ...
        <div class="col-xl-8">
            <div class="card">
                <div class="card-header  text-capitalize">
                    <h6 class="mb-0">Battery Installation View</h6>
                </div>
                <div class="card-body">
    ...
    @push('scripts')
        <script>
            ...
            function categoryupdate(id, title) {
                var url = "{{ asset('admin/batteryinstallationupdate/') }}";
            ...
            $(document).ready(function() {
                ...
                $("#basic21").DataTable({
                    ...
                    serverMethod: "POST",
                    ajax: {
                        url: "{{ asset('admin/houseajexbatteryinstallation') }}",
                    },
                    columns: [{
                            data: "id",
                            title: "Sr. No."
