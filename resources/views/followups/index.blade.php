                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach ($amount as $key => $value)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $value['total_amount'] - $value['achieved_amount'] }}
                                                                    </td>
                                                                </tr>
                                                                @php
                                                            ...
                                                            @if (in_array(auth()->user()->role, ['admin']))
                                                                <tr class="bg-info">
                                                                    <td>Total</td>
                                                                    <td>{{ $total_target }}</td>
                                                                    <td>{{ $total_achieved }}</td>
                                                                    <td>{{ $total_target - $total_achieved }}</td>
                                                                </tr>
                                                            @endif
                                                        </tbody>
                                                    </table>
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12 pt-1">
                            <div class="form-group">
                                ...
                                <textarea name="latest_comment" class="form-control" id="latest_comment"></textarea>
                            </div>
                        </div>
