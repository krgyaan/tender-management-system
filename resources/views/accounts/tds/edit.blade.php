    ...
    <section>
        <div class="row">
            <div class="col-md-10 m-auto">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('tds.update', $tds->id) }}" method="POST"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="datetime-local" class="form-control"
                                                            ...
                                                            value="{{ old('payments.' . $index . '.payment_date', $payment->payment_date->format('Y-m-d\TH:i')) }}"
                                                            required>
                                                    </td>
                                                    <td class="text-center">
                                                        @if ($index === 0)
                                                            <button type="button"
                                                                class="btn btn-sm btn-success add-row-btn w-100">
                                                                + Add
                                                            </button>
                                                        @else
                                                            <button type="button"
                                                                class="btn btn-sm btn-danger remove-row-btn w-100">
                                                                Remove
                                                            </button>
                                                        @endif
                                                    </td>
                            ...
                            <div class="d-flex justify-content-end mt-4 border-top pt-3">
                                <a href="{{ route('tds.index') }}" class="btn btn-outline-secondary me-3">
                                    Back
                                </a>
    ...
    <script>
        $(document).on('click', '.add-row-btn', function() {
            ...
            <tr>
                ...
                <td>
                    <input type="number" class="form-control" name="payments[${rowCount}][amount]" step="0.01" min=0 required>
                </td>
                <td>
                ...
                <td class="text-center">
                    <button type="button" class="btn btn-sm btn-danger remove-row-btn w-100">
                        Remove
                    </button>
                </td>
            </tr>
