...
<head>
    ...
    <title>Feedback Submitted | Volks Energie</title>
    ...
    <div class="container my-5">
        <div class="card p-5 text-center">
            <div class="card-body">
                ...
                <h3 class="success-message">Thank You for Your Feedback!</h3>
                <p class="mt-3">We truly appreciate you taking the time to share your thoughts with us.
                    Your feedback helps us improve and serve you better.</p>
                <a href="https://volksenergie.in/" class=" mt-4">Back to Home</a>
            </div>
        </div>
    </div>
