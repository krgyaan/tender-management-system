            ...
            <div class="modal-content">
                <form action="" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="approveSheetModalLabel">Approve Private Costing Sheet</h5>
    ...
    <script>
        ...
        function initializeTable(type) {
            ...
            tables[type] = $(`#${type}Table`).DataTable({
                ...
                ajax: {
                    url: `/pvt-costing-approval/data/${type}`,
                    method: 'GET',
                    data: function(d) {
    ...
    <script>
        $(document).ready(function() {
            $('#approveSheetModal').on('show.bs.modal', function(event) {
                ...
                var $modal = $(this);
                form.attr('action', '/bdm/private-costing-sheet/' + tenderId + '/approval');
