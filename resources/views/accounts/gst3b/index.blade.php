        ...
        <div class="col-md-12 m-auto">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('accounts.gst3b.create') }}" class="btn btn-primary mt-2 mb-3">+ Add
                        Expense</a>
                                ...
                                @forelse($gst3bs as $gst3b)
                                    <tr class="border-top">
                                        ...
                                        <td style="white-space: nowrap;">
                                            <a href="{{ route('accounts.gst3b.show', $gst3b->id) }}"
                                                class="btn btn-sm btn-info mb-1">View</a>
                                            <a href="{{ route('accounts.gst3b.edit', $gst3b->id) }}"
                                    ...
                                    <div class="modal fade" id="uploadModal{{ $gst3b->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <form method="POST"
                                                action="{{ route('accounts.gst3b.uploadPaymentChallan', $gst3b->id) }}"
