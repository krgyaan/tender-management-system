            ...
            <div class="row shadow-lg rounded overflow-hidden" style="width: 90%; max-width: 1000px;">
                ...
                <div class="col-md-6 bg-white p-5">
                    <div class="text-center mb-4">
                        <h2 class="fw-bold py-2">Login to Your Account</h2>
                        <p class="text-muted">
                            @if (isset($name))
                                Welcome back, {{ $name }}!
                            @else
                                Welcome to Tender Management System.
                                <br class="d-none d-md-block">Please sign in to continue.
                            @endif
                        </p>
                    </div>
                    ...
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        {{-- Hidden Role Selection (if needed) --}}
