                                            ...
                                            <tbody>
                                                @foreach ($employeeimprest as $employee)
                                                    <tr>
                                                        ...
                                                        <td>{{ format_inr($employee->getAmtReceived($employee->name_id)) }}
                                                        </td>
                                                        <td>{{ format_inr($employee->getAmtSpent($employee->name_id)) }}
                                                        </td>
                                                        <td>{{ format_inr($employee->getAmtApproved($employee->name_id)) }}
                                                        </td>
                                                        <td>{{ format_inr($employee->getAmtLeft($employee->name_id)) }}
                                                        </td>
                                                        <td>
                                                            <a href="{{ asset('/admin/employeeimprest_dashboard') }}/{{ $employee->name_id }}"
