                ...
                <table class="w-100 table-bordered mb-0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{ $lead->next_followup_date ? \Carbon\Carbon::parse($lead->next_followup_date)->format('d M Y') : 'N/A' }}
                            </td>
                        ...
                        <tr>
                            ...
                            <td>{{ $lead->last_call_at ? \Carbon\Carbon::parse($lead->last_call_at)->format('d M Y H:i') : 'Never' }}
                            </td>
                            <td>N/A</td>
                        ...
                        <tr>
                            ...
                            <td>{{ $lead->last_whatsapp_sent_at ? \Carbon\Carbon::parse($lead->last_whatsapp_sent_at)->format('d M Y H:i') : 'Never' }}
                            </td>
                            <td>N/A</td>
