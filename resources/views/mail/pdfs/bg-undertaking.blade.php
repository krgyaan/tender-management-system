...
<div>
    ...
    <p style="margin-top: 20px">
        We, <b>M/s Volks Energie Private Limited</b>, a company incorporated under the Companies Act, 1956 and having
        Registered Office at B1/D8 2nd Floor, Mohan Cooperative Industrial Estate, New Delhi-110044 (hereinafter
        referred to as
        "Company") in consideration of your issuing/ having issued Bank Guarantee No. _________________________ for Rs
        {{ format_inr($data['bg_amt']) }} (Rupees Only) in favor of <b>{{ $data['bg_favour'] }}</b> ("said Deed")
        pursuant to Bank Guarantee Facilities sanctioned to us vide your facility ref. no BB/2307200147/10082023/002932
        dated 10/08/2023 ("Facility Letter").
    </p>

    <p>
        We confirm that we are fully aware of the risks associated with issuance of the bank guarantee/indemnity as per
        ...
        validity period of the Bank Guarantee/Indemnity issued in favor of <b>{{ $data['bg_favour'] }}</b> as per the
    ...
    <ol style="margin-left: 20px">
        ...
        <li>We hereby agree and confirm that it shall be your sole discretion whether to renew/ extend the said Deed.
        </li>
        <li>Request for renewal/ extension of said Deed shall be submitted at least 30 days prior to the expiry of the
            said Deed.</li>
        ...
        <li>To pay all amounts claimed by the beneficiary of the Bank Guarantee/Indemnity together with charges, costs,
        ...
        <li>To honour all claims made under the Bank Guarantee/Indemnity even after validity period if any since we
            understand that claim under an indemnity can be made at any time unless the same is expressly revoked by the
            beneficiary.</li>
    </ol>
    ...
    <p style="font-weight: bold;">
        The Common Seal of <b>Volks Energie Private Limited</b> has pursuant to the Resolution of its Board of Directors
        passed in that behalf on the <b>{{ \Carbon\Carbon::parse($data['date'])->format('jS \d\a\y \o\f M Y') }}</b>
        hereunto been affixed in the presence of Mr. Piyush Goyal authorized officer who has signed these presents in
        token thereof.
    </p>
</div>
