                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table-bordered" style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ optional($emd->emdDemandDrafts->first())->courier_add ?? '' }}</td>
                                        </tr>
                                        <tr>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table-bordered" style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $banks[$emd->emdCheques->first()->cheque_bank] }}</td>
                                        </tr>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table-bordered" style="width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $emdBg = optional($emd->emdBgs->first());
                                                        $courierDocRaw = optional($emdBg->courier)->courier_docs;
                                                        $courierDoc = is_string($courierDocRaw) ? json_decode($courierDocRaw, true)[0] ?? null : $courierDocRaw;
                                                        $bgSoftCopy = $emdBg->bg_soft_copy;
                                                    
                                                        $pathCourier = public_path('uploads/courier_docs/' . $bgSoftCopy);
                                                        $pathEmds = public_path('uploads/emds/' . $bgSoftCopy);
                                                    @endphp
                                                    
                                                    @if ($courierDoc)
                                                        <a href="{{ asset('uploads/courier_docs/' . $courierDoc) }}" target="_blank">View</a>
                                                    @elseif ($bgSoftCopy && file_exists($pathCourier))
                                                        <a href="{{ asset('uploads/courier_docs/' . $bgSoftCopy) }}" target="_blank">View Uploaded File</a>
                                                    @else
                                                        Not Uploaded
                                                    @endif
                                                </td>
                                            ...
                                            @switch(optional($emd->emdBankTransfers->first())->action ?? '')
                                                @case('1')
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @php
                                                                $transfer = optional($emd->emdBankTransfers->first());
                                                                $formattedDate = $transfer->date_time ? date('d-m-Y h:i:A', strtotime($transfer->date_time)) : '';
                                                            @endphp
                                                            {{ $formattedDate }}
                                                        </td>
                                                    </tr>
                                            ...
                                            @switch(optional($emd->emdPayOnPortals->first())->action ?? '')
                                                @case('1')
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @php
                                                                $pay = optional($emd->emdPayOnPortals->first());
                                                                $formattedDate = $pay->date_time ? date('d-m-Y h:i:A', strtotime($pay->date_time)) : '';
                                                            @endphp
                                                            {{ $formattedDate }}
                                                        </td>
                                                    </tr>
