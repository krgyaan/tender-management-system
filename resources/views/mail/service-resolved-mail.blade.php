...
<body>
    <p><strong>Subject:</strong> Ticket No. {{ $data['call_no'] }}, Service Request received.</p>
    ...
    <p>
        <strong>Site Name/साइट का नाम या साइट का पता:</strong> {{ $data['site_name'] }} <br>
        <strong>Your Issue/आपकी समस्या:</strong> {{ $data['issue'] }} <br>
    ...
    <p>
        <strong>Feedback Link:</strong> <a href="{{ $data['feedback_link'] }}" target="_blank">{{ $data['feedback_link'] }}</a>
    </p>
    ...
    <p>
        ...
        <strong>टिप्पणी :</strong> {{ $data['resolution'] }}
    </p>
    ...
    <p>
        <strong>प्रतिक्रिया लिंक :</strong> <a href="{{ $data['feedback_link'] }}" target="_blank">{{ $data['feedback_link'] }}</a>
    </p>
