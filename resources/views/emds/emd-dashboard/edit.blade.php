                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="tender" class="form-control"
                                            value="{{ $tender ? $tender->tender_no : $emd->tender_no }}" readonly>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="project_name" class="form-control" id="project_name"
                                            value="{{ $emd->project_name }}" readonly>
                                        <small class="text-muted">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="instrument_type" class="form-control" id="instrument_type" readonly>
                                            <option value="">-- Select --</option>
                                            @foreach ($instrumentType as $key => $value)
                                                <option {{ $emd->instrument_type == $key ? 'selected' : '' }}
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="requested_by" class="form-control" id="requested_by"
                                            value="{{ $emd->requested_by }}" readonly>
                                        <small class="text-muted">
                                            ...
                                            <div class="row" id="demand_draft">
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="text" name="dd_favour" id="dd_favour"
                                                        class="form-control" value="{{ $allData->dd_favour }}">
                                                    <small class="text-muted">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="number" name="dd_amt" id="dd_amt" min="0"
                                                        step="0.01" class="form-control" value="{{ $allData->dd_amt }}">
                                                    <small class="text-muted">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="text" name="dd_payable" id="dd_payable"
                                                        class="form-control" value="{{ $allData->dd_payable }}">
                                                    <small class="text-muted">
                                                ...
                                                <div class="col-md-4 form-group {{ $tid == '00' ? 'd-none' : '' }}">
                                                    ...
                                                    <textarea name="courier_add" id="courier_add" class="form-control" {{ $tid == '00' ? '' : 'required' }}>{{ $allData->courier_add }}</textarea>
                                                    <small class="text-muted">
                                                        <span
                                            ...
                                            <div class="row" id="fdr">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="text" name="fdr_favour" id="fdr_favour"
                                                        class="form-control" value="{{ $allData->fdr_favour }}">
                                                    <small class="text-muted">
                                                        <span
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="date" name="fdr_expiry" id="fdr_expiry"
                                                        class="form-control" value="{{ $allData->fdr_expiry }}">
                                                    <small class="text-muted">
                                                        <span
                                            ...
                                            <div class="row" id="cheque">
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="text" name="cheque_favour" id="cheque_favour"
                                                        class="form-control" value="{{ $allData->cheque_favour }}">
                                                    <small class="text-muted">
                                                        <span
                                        ...
                                        @elseif($ins == '4')
                                            <div class="row" id="bg">
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <select name="bg_needs" id="bg_needs" class="form-control">
                                                        <option value="">Select</option>
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="text" name="bg_favour" id="bg_favour"
                                                        class="form-control" value="{{ $allData->bg_favour }}">
                                                    <small class="text-muted">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <textarea name="bg_address" id="bg_address" class="form-control">{{ $allData->bg_address }}</textarea>
                                                    <small class="text-muted">
                                                        <span
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="date" name="bg_expiry" id="bg_expiry"
                                                        class="form-control" value="{{ $allData->bg_expiry }}">
                                                    <small class="text-muted">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="date" name="bg_claim" id="bg_claim"
                                                        class="form-control" value="{{ $allData->bg_claim }}">
                                                    <small class="text-muted">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="file" name="bg_format_te" id="bg_format_te"
                                                        class="form-control">
                                                    @if ($allData->bg_format_te)
                                                        <small class="text-muted">
                                                            <a href="{{ asset('uploads/emds/' . $allData->bg_format_te) }}"
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    @if ($allData->bg_po)
                                                        <small class="text-muted">
                                                            <a href="{{ asset('uploads/emds/' . $allData->bg_po) }}"
                                                                target="_blank">View Uploaded File</a>
                                                        </small>
                                                    @endif
                                                    <small class="text-muted">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <div class="input-group mb-1">
                                                        <input type="text" name="bg_bank_ifsc" id="bg_bank_ifsc"
                                                            class="form-control" placeholder="IFSC"
                                                            value="{{ $allData->bg_bank_ifsc }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 form-group">
                                                    <label class="form-label" for="bg_courier_addr">BG Courier
                                                        Address</label>
                                                    <textarea name="bg_courier_addr" id="bg_courier_addr" class="form-control">{{ $allData->bg_courier_addr }}</textarea>
                                                    <small class="text-muted">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="text" name="bg_no" id="bg_no"
                                                        class="form-control" value="{{ $allData->bg_no }}">
                                                    <small class="text-muted">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="date" name="bg_date" id="bg_date"
                                                        class="form-control" value="{{ $allData->bg_date }}">
                                                    <small class="text-muted">
                                                        <span class="text-danger">{{ $errors->first('bg_date') }}</span>
                                                    </small>
                                                </div>

                                                <div class="col-md-4 form-group">
                                                    <label class="form-label" for="bg_soft_copy">Upload Soft copy of the
                                                        BG</label>
                                                    <input type="file" name="bg_soft_copy" id="bg_soft_copy"
                                                        class="form-control" accept=".pdf,.doc,.docx,image/*">
                                                    @php
                                                        $fileName = $allData->bg_soft_copy;
                                                        $path1 = public_path('uploads/courier_docs/' . $fileName);
                                                        $path2 = public_path('uploads/emds/' . $fileName);
                                                    @endphp
                                                    
                                                    @if (file_exists($path1))
                                                        <small class="text-muted">
                                                            <a href="{{ asset('uploads/courier_docs/' . $fileName) }}" target="_blank">View Uploaded File</a>
                                                        </small>
                                                    @elseif (file_exists($path2))
                                                        <small class="text-muted">
                                                            <a href="{{ asset('uploads/emds/' . $fileName) }}" target="_blank">View Uploaded File</a>
                                                        </small>
                                                    @endif

                                                    <small class="text-muted">
                                                        <span
                                                            class="text-danger">{{ $errors->first('bg_soft_copy') }}</span>
                                                    </small>
                                                </div>

                                                <div class="col-md-4 form-group">
                                                    <label class="form-label" for="sfms">SFMS</label>
                                                    <input type="file" name="sfms" id="sfms"
                                                        class="form-control" accept=".pdf,.doc,.docx,image/*">
                                                    @if ($allData->sfms)
                                                        <small class="text-muted">
                                                            <a href="{{ asset('uploads/emds/' . $allData->sfms) }}"
                                                                target="_blank">View Uploaded File</a>
                                                        </small>
                                                    @endif
                                                    <small class="text-muted">
                                                        <span class="text-danger">{{ $errors->first('sfms') }}</span>
                                                    </small>
                                                </div>
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="any" min="0"
                                                            name="fdr_per" id="fdr_per" class="form-control"
                                                            value="{{ $allData->fdr_per }}">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="file" name="fdr_copy" id="fdr_copy"
                                                        class="form-control" accept=".pdf,.doc,.docx,image/*">
                                                    @if ($allData->fdr_copy)
                                                        <small class="text-muted">
                                                            <a href="{{ asset('uploads/emds/' . $allData->fdr_copy) }}"
                                                                target="_blank">View Uploaded File</a>
                                                        </small>
                                                    @endif
                                                    <small class="text-muted">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    <label class="form-label" for="fdr_amt">FDR Amount</label>
                                                    <input type="number" step="any" min="0" name="fdr_amt"
                                                        id="fdr_amt" class="form-control"
                                                        value="{{ $allData->fdr_amt }}">
                                                    <small class="text-muted">
                                                        <span class="text-danger">{{ $errors->first('fdr_amt') }}</span>
                                                    </small>
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="text" name="fdr_no" id="fdr_no"
                                                        class="form-control" value="{{ $allData->fdr_no }}">
                                                    <small class="text-muted">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="date" name="fdr_validity" id="fdr_validity"
                                                        class="form-control" value="{{ $allData->fdr_validity }}">
                                                    <small class="text-muted">
                                                        <span
                                                            class="text-danger">{{ $errors->first('fdr_validity') }}</span>
                                                    </small>
                                                </div>
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" name="fdr_roi" id="fdr_roi"
                                                            class="form-control" step="any" min="0"
                                                            value="{{ $allData->fdr_roi }}">
                                                        <span class="input-group-text">%</span>
                                                    </div>
                                                    <small class="text-muted">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="number" name="bg_charges" id="bg_charges"
                                                        class="form-control" step="0.01" min="0"
                                                        value="{{ $allData->bg_charge_deducted }}">
                                                    <small class="text-muted">
                                                        <span
                                                            class="text-danger">{{ $errors->first('bg_charges') }}</span>
                                                    </small>
                                                </div>

                                                <div class="col-md-4 form-group">
                                                    <label class="form-label" for="sfms_charges">SFMS Charges
                                                        Deducted</label>
                                                    <input type="number" name="sfms_charges" id="sfms_charges"
                                                        class="form-control" step="0.01" min="0"
                                                        value="{{ $allData->sfms_charge_deducted }}">
                                                    <small class="text-muted">
                                                        <span
                                                            class="text-danger">{{ $errors->first('sfms_charges') }}</span>
                                                    </small>
                                                </div>

                                                <div class="col-md-4 form-group">
                                                    <label class="form-label" for="stamp_charges">Stamp Paper Charges
                                                        Deducted</label>
                                                    <input type="number" name="stamp_charges" id="stamp_charges"
                                                        class="form-control" step="0.01" min="0"
                                                        value="{{ $allData->stamp_charge_deducted }}">
                                                    <small class="text-muted">
                                                        <span
                                                            class="text-danger">{{ $errors->first('stamp_charges') }}</span>
                                                    </small>
                                                </div>

                                                <div class="col-md-4 form-group">
                                                    <label class="form-label" for="other_charges">Other Charges
                                                        Deducted</label>
                                                    <input type="number" name="other_charges" id="other_charges"
                                                        class="form-control" step="0.01" min="0"
                                                        value="{{ $allData->other_charge_deducted }}">
                                                    <small class="text-muted">
                                                        <span
                                                            class="text-danger">{{ $errors->first('other_charges') }}</span>
                                                    </small>
                                                </div>

                                                <div class="col-md-4 form-group">
                                                    <label class="form-label" for="remarks">Remarks</label>
                                                    <textarea name="remarks" id="remarks" class="form-control" rows="3">{{ $allData->remarks }}</textarea>
                                                    <small class="text-muted">
