@extends('layouts.app')
@section('page-title', 'Costing Approval Details')
@section('content')
    @php
        $reason = [
            9 => 'OEM Bidders only',
                                        ...
                                        <td colspan="3">
                                            <ul>
                                                @forelse ($tender->docs as $item)
                                                    <a href="{{ asset('uploads/docs/' . $item->doc_path) }}"
                                                    target="_blank" rel="noopener noreferrer">View Tender Docs</a>
                                                @empty
                        ...
                        <table class="table-bordered w-100 mt-2">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($rfq->docs_list)
                                            {!! nl2br(wordwrap($rfq->docs_list, 50, "\n")) !!}
                                        @endif
                                    </td>
                                </tr>
                            </tbody>
