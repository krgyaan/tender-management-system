...
class ServiceResolvedMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Ticket No. ' . ($this->data['ticket_no'] ?? 'N/A') . ', Service Request resolved.',
        );
    }
    ...
    {
        return new Content(
            view: 'mail.customer_service.service-resolved-mail',
            with: [
                'data' => $this->data,
            ],
        );
