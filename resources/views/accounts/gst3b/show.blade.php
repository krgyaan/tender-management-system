...
@section('content')
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="{{ route('accounts.gst3b.edit', $gst3b->id) }}" class="btn btn-sm btn-primary me-2">
                    Edit
                </a>
                <a href="{{ route('accounts.gst3b.index') }}" class="btn btn-sm btn-secondary">
                    Back
                </a>
            </div>
        </div>
        ...
        @can('approve', $gst3b)
            <div class="border-top pt-3 mt-4">
                <h5>Admin Actions</h5>
                <form action="{{ route('accounts.gst3b.approve', $gst3b->id) }}" method="POST" class="d-inline">
                    @csrf
            ...
            <div class="modal fade" id="rejectModal" tabindex="-1" aria-labelledby="rejectModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="{{ route('accounts.gst3b.reject', $gst3b->id) }}" method="POST">
                            @csrf
