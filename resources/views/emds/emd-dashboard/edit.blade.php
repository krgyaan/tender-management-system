                                        ...
                                        @elseif($ins == '4')
                                            <div class="row" id="bg">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    @if ($allData->bg_soft_copy)
                                                        <small class="text-muted">
                                                            <a href="{{ asset('uploads/emds/' . $allData->bg_soft_copy) }}"
                                                                target="_blank">View Uploaded File</a>
                                                        </small>
                                                    @endif
                                                    <small class="text-muted">
