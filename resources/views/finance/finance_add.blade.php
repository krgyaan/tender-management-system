                ...
                <div class="col-xl-12 mx-auto">
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <form method="post" action="{{ asset('/admin/finance_post') }}" enctype="multipart/form-data"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="document_name" class="form-control" id=""
                                    ...
                                    <select name="document_type" class="form-control" required>
                                        ...
                                        @foreach ($documenttype as $key => $documenttypeItem)
                                            <option value="{{ $documenttypeItem->id }}">
                                                {{ $documenttypeItem->document_type }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                    ...
                                    <select name="financial_year" class="form-control" required>
                                        ...
                                        @foreach ($financialyear as $key => $financialyearItem)
                                            <option value="{{ $financialyearItem->id }}">
                                                {{ $financialyearItem->financial_year }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6">
