        ...
        <div class="row">
            <div class="col-md-12 m-auto">
                ...
                <div class="d-flex justify-content-start align-items-center mb-2">
                    <a href="{{ route('accounts.gstr1.create') }}" class="btn btn-sm btn-primary">Add New</a>
                </div>
                            ...
                            <tbody>
                                @forelse ($gstR1s as $gstR1)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('accounts.gstr1.edit', $gstR1->id) }}"
                                                class="btn btn-sm btn-warning">Edit</a>
                                            <a href="{{ route('accounts.gstr1.show', $gstR1->id) }}"
