...
class ServiceVisitDoneMail extends Mailable
{
    ...
    {
        $this->data = $data;
          \Log::info('Data passed to ServiceVisitDoneMail:', $data);
    }
    ...
    {
        return new Envelope(
            subject: ' Ticket No. - , Site visit report.
',
        );
    }
    ...
    {
        return new Content(
            view: 'mail.customer_service.service-visit-done-mail',
            with: [
                'data' => $this->data,
            ],
        );
