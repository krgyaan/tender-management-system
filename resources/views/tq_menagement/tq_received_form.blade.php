                        ...
                        <form method="post" action="{{ asset('/admin/tq_received_form_post') }}" enctype="multipart/form-data"
                            ...
                            <div class="row">
                                <div class="col-md-4 pt-3">
                                    <label for="date" class="form-label">TQ Submission Date</label>
                                    <input type="date" class="form-control" name="date" id="date" required>
                                </div>
                                <div class="col-md-4 pt-3">
                                    <label for="time" class="form-label">TQ Submission Time</label>
                                    <input type="time" class="form-control" name="time" id="time" required>
                                </div>
                                <div class="col-md-4 pt-3">
                                    <label for="tq_img" class="form-label">Uplode TQ document</label>
                                    <input type="file" class="form-control" name="tq_img" id="tq_img">
                                </div>
                            </div>
