    ...
    <aside class="sidebar sidebar-default navs-rounded ">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="{{ route('dashboard') }}" class="navbar-brand dis-none align-items-center justify-content-center">
                ...
                <h5 class="logo-title m-0">&nbsp; {{ config('app.name') }}</h5>
            </a>
        ...
        <div class="sidebar-body p-0 data-scrollbar">
            <div class="collapse navbar-collapse pe-3" id="sidebar">
                <ul class="navbar-nav iq-main-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-tender" data-bs-parent="#sidebar">
                            ...
                            <li
                                ...
                                <a class="nav-link d-flex align-items-center {{ request()->routeIs('admin/googlesheet') ? 'active' : '' }}"
                            ...
                            <li class="nav-item d-none">
                                <a class="nav-link d-flex align-items-center {{ request()->is('admin/batteryprice') ? 'active' : '' }}"
                                    href="{{ url('/admin/batteryprice') }}">
                                    <i class="fa fa-arrow-right"></i>
                                    <span class="item-name fw-normal">Battery Price Sheet</span>
                                </a>
                            </li>
                            <li class="nav-item d-none">
                                <a class="nav-link d-flex align-items-center {{ request()->is('admin/batteryinstallation') ? 'active' : '' }}"
                                    href="{{ url('/admin/batteryinstallation') }}">
                                    <i class="fa fa-arrow-right"></i>
                                    <span class="item-name fw-normal">Battery Installation</span>
                                </a>
                            </li>
                            <li class="nav-item d-none">
                                <a class="nav-link d-flex align-items-center {{ request()->is('admin/batteryaccessories') ? 'active' : '' }}"
                                    href="{{ url('/admin/batteryaccessories') }}">
                                    <i class="fa fa-arrow-right"></i>
                                    <span class="item-name fw-normal">Battery Accessories</span>
                                </a>
                            </li>
                            <li
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-bi" role="button"
                        ...
                        <ul class="sub-nav collapse" id="sidebar-bi" data-bs-parent="#sidebar">
                            <li class="nav-item d-none">
                                <a class="nav-link d-flex align-items-center {{ request()->routeIs('emds-dashboard.index') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-docDash" data-bs-parent="#sidebar">
                            ...
                            <li
                                ...
                                <a class="nav-link d-flex align-items-center {{ request()->is('admin/basicdetailview') ? 'active' : '' }}"
                                    href="{{ url('/admin/basicdetailview') }}">
                                    <i class="fa fa-arrow-right"></i>
                            ...
                            <li
                                ...
                                <a class="nav-link d-flex align-items-center {{ request()->is('admin/kickmeeting_dashbord') ? 'active' : '' }}"
                            ...
                            <li
                                ...
                                <a class="nav-link d-flex align-items-center {{ request()->is('admin/contract_dashboardview') ? 'active' : '' }}"
