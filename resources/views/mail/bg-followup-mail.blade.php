<div>
    ...
    <p>The status of the Tender no. {{ $data['tenderNo'] }}, project name {{ $data['projectName'] }}, is
        {{ $data['status'] }}.</p>

    <p>Please initiate the process of releasing the EMD in the form of BG for Rs. {{ $data['amount'] }} submitted
