...
@section('page-title', 'Create TDS Form')
    ...
    <section>
        <div class="row">
            <div class="col-md-10 m-auto">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('accounts.tds.index') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button type="button" class="btn btn-sm btn-success add-row-btn w-100">
                                                        + Add
                                                    </button>
                                                </td>
                                            </tr>
