        ...
        <div class="col-md-12">
            <div class="card m-auto">
                <div class="card-body" id="print">
                    ...
                    <div class="ra-mgmt py-3">
                        @if ($ra)
                            <div class="text-center text-white fw-bold">
                                <h5 class="card-title text-center">RA Details</h5>
                            </div>
                            <div class="table-responsive">
                                <table class="table-bordered w-100">
                                    <tbody>
                                        <tr>
                                            <th class="text-white fw-bold">No. of Qualified Parties</th>
                                            <td>{{ count(json_decode($ra->qualified_parties ?? '[]')) }}</td>
                                            <th class="text-white fw-bold">Names of Qualified Parties</th>
                                            <td>
                                                @if ($ra->qualified_parties)
                                                    <ul class="mb-0">
                                                        @foreach (json_decode($ra->qualified_parties) as $party)
                                                            <li>{{ $party }}</li>
                                                        @endforeach
                                                    </ul>
                                                @else
                                        ...
                                        <tr>
                                            <th class="text-white fw-bold">Screenshot of Qualified Parties</th>
                                            <td>
                                                @if ($ra->qualified_parties_screenshot)
                                                    <a href="{{ asset('ra_results/' . $ra->qualified_parties_screenshot) }}"
                                                        target="_blank">View</a>
                                                @else
                                                    Not uploaded
                                                @endif
                                            </td>
                                            <th class="text-white fw-bold">RA Result: %age Below Start Price</th>
                                            <td>
                                                @if ($ra->ra_start_price && $ra->ra_close_price)
                                                    {{ number_format((($ra->ra_start_price - $ra->ra_close_price) / $ra->ra_start_price) * 100, 2) }}%
                                                @else
                                                    NA
                                                @endif
                                            </td>
                                        ...
                                        <tr>
                                            <th class="text-white fw-bold">RA Duration</th>
                                            <td>
                                                @if ($ra->start_time && $ra->end_time)
                                                    @php
                                                        $start = \Carbon\Carbon::parse($ra->start_time);
                                                        $end = \Carbon\Carbon::parse($ra->end_time);
                                            ...
                                            <th class="text-white fw-bold">Screenshot of Decrements</th>
                                            <td>
                                                @if ($ra->decrements_screenshot)
                                                    <a href="{{ asset('ra_results/' . $ra->decrements_screenshot) }}"
                                                        target="_blank">View</a>
                                                @else
                                                    Not uploaded
                                                @endif
                                        ...
                                        <tr>
                                            <th class="text-white fw-bold">Screenshot of Final Result</th>
                                            <td colspan="3">
                                                @if ($ra->final_result)
                                                    <a href="{{ asset('ra_results/' . $ra->final_result) }}"
                                                        target="_blank">View</a>
                                                @else
                                                    Not uploaded
                                                @endif
