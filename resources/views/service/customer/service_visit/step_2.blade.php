        ...
        <section>
            <div class="card p-4">
                <div class="card-body">
                    ...
                    <form action="{{ route('service_visit.public.store.step2') }}" method="POST" class="row g-3"
                        enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" value={{ $complaintId }} name="complaint_id">

                        <div class="col-md-4">
                            <label class="form-label">Photos After Resolution</label>
                            <div class="row g-2">
                                @if (!session()->has('service_visit_photos.resolved') || empty(session('service_visit_photos.resolved')))
                                    <!-- Option 1: Upload -->
                                    <div class="col-12 col-md-6">
                                        <input type="file" name="resolution_photos[]" class="form-control"
                                    ...
                                    <!-- Option 2: Click -->
                                    <div class="col-12 col-md-6">
                                        <a href={{ route('service_visit.public.camera', ['resolved', $complaintId]) }}
                                            class="btn btn-outline-secondary">
                                            <i class="fa fa-camera"></i> Click Photo
                                        </a>
                                    </div>
                                @else
                                    <div>
                                        <span class="text-success">Photos Saved</span>
                                        {{-- <form action="{{ route('service_visit.clear_photos', $complaintId) }}" method="POST"
                                        class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger btn-sm ms-2">
                                            <i class="fa fa-trash"></i> Clear Photos
                                        </button>
                                    </form> --}}
                                    </div>
                                @endif
                        ...
                        <!-- Upload Customer-Un-Signed Visit Report -->
                        <div class="col-md-4">
                            <label class="form-label">Upload Customer Un-Signed Visit Report</label>
                            <div class="row g-2">
                                @if (!session()->has('service_visit_photos.unsigned') || empty(session('service_visit_photos.unsigned')))
                                    <!-- Option 1: Upload -->
                                    <div class="col-md-6">
                                        <input type="file" name="unsigned_visit_report[]" class="form-control"
                                            accept=".pdf,.jpg,.jpeg,.png" multiple>
                                    </div>

                                    <!-- Option 2: Click -->
                                    <div class="col-md-6">
                                        <a href="{{ route('service_visit.public.camera', ['unsigned', $complaintId]) }}"
                                            class="btn btn-outline-secondary">
                                            <i class="fa fa-camera"></i> Click Photo
                                        </a>
                                    </div>
                        ...
                        <div class="col-md-4">
                            <label class="form-label">Upload Customer-Signed Visit Report</label>
                            <div class="row g-2">
                                @if (!session()->has('service_visit_photos.signed') || empty(session('service_visit_photos.signed')))
                                    <!-- Option 1: Upload -->
                                    <div class=" col-md-6">
                                        <input type="file" name="visit_report[]" class="form-control"
                                            accept=".pdf,.jpg,.jpeg,.png" multiple>
                                    ...
                                    <!-- Option 2: Click -->
                                    <div class=" col-md-6">
                                        <a href="{{ route('service_visit.public.camera', ['signed', $complaintId]) }}"
                                            class="btn btn-outline-secondary ">
                                            <i class="fa fa-camera"></i> Click Photo
                                        </a>
                        ...
                        <div class="col-md-12 text-end">
                            <button type="submit" class="btn btn-primary px-4">Submit Visit</button>
                            <a href="{{ route('service_visit.public.step1', $complaintId) }}"
