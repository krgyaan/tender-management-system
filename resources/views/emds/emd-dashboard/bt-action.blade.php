@extends('layouts.app')
@section('page-title', 'Bank Transfer Actions')
@php
    $ferq = [
        '1' => 'Daily',
        '2' => 'Alternate Days',
            ...
            <div class="col-md-12 m-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('bt-action', $emd->id) }}" method="post" enctype="multipart/form-data"
                            id="updateStatusForm">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-control" id="popaction" name="action" required>
                                        ...
                                        @foreach ($popStatus as $key => $value)
                                            <option value="{{ $key }}"
                                                {{ $emd->action == $key ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row" style="display: {{ $emd->action == '1' ? 'flex' : 'none' }}"
                                id="popaccount">
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="status" class="form-control" id="status">
                                        ...
                                        <option value="Accepted" {{ $emd && $emd->status == 'Accepted' ? 'selected' : '' }}>
                                            Accepted
                                        </option>
                                        <option value="Rejected" {{ $emd && $emd->status == 'Rejected' ? 'selected' : '' }}>
                                            Rejected
                                        </option>
                                    </select>
                            ...
                            <div class="row" style="display: {{ $emd->action == '2' ? 'flex' : 'none' }}"
                                id="popfollowup">
                                <div class="col-md-4">
                            ...
                            <div class="row" style="display: {{ $emd->action == '3' ? 'flex' : 'none' }}"
                                id="poptransfer">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label" for="transfer_date">Transfer Date:</label>
                                        <input type="date" name="transfer_date" class="form-control"
                                            id="transfer_date" value="{{ $emd->transfer_date }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
