                ...
                <div class="card">
                    <div class="card-body p-4">
                        <form method="post" action="{{ asset('/admin/loancloseupdate_post') }}" enctype="multipart/form-data"
                            id="format-update" class="row g-3 needs-validation" novalidate>
                            @csrf
                            ...
                            <div class="col-md-4 ">
                                ...
                                <div class="d-flex"> <input type="file" name="banknoc_document" class="form-control"
                                        id="input38" required>
                                    <a class="ms-2 mt-1"
                                        href="{{ asset('upload/loanclose/' . $loanclose->banknoc_document) }}" download
                                        data-caption="">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="d-flex">
                                    <input type="file" name="closurecreated_mca" class="form-control" id="input38"
                                        required>
                                    <a class="ms-2 mt-1"
                                        href="{{ asset('upload/loanclose/' . $loanclose->closurecreated_mca) }}" download
                                        data-caption="">
                                        <i class="fa fa-download"></i>
                                    </a>
                                </div>
