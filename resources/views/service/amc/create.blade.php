@extends('layouts.app')
@section('page-title', 'Add AMC Record')
@section('content')
    <section>
        <div class="card mb-4">
            <div class="card-body">
                ...
                <form action="{{ route('amc.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div id="sites-container">
                        <!-- First Site -->
                        <div class="site-entry mb-4 border border-secondary p-3">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <span>Site #1</span>
                                <button type="button" class="btn btn-sm btn-danger remove-site" disabled>
                                    Remove Site
                                </button>
                            </div>
                            <div class="site-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="sites[0][address]" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label class="form-label">Google Maps Link</label>
                                            <input type="url" class="form-control" name="sites[0][map_link]">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <input type="text" class="form-control"
                                                    name="sites[0][contacts][0][name]" placeholder="Name" required>
                                            </div>
                                            <div class="col-md-2">
                                                <input type="text" class="form-control"
                                                    name="sites[0][contacts][0][organization]" placeholder="Organization">
                                            </div>
                                            <div class="col-md-3">
                                                <input type="tel" class="form-control"
                                                    name="sites[0][contacts][0][mobile]" placeholder="Mobile" required>
                                            </div>
                                            <div class="col-md-3">
                                                <input type="email" class="form-control"
                                                    name="sites[0][contacts][0][email]" placeholder="Email">
                                            </div>
                                            <div class="col-md-2">
                                ...
                                <button type="button" class="btn btn-sm btn-secondary add-contact" data-site-index="0">
                                    Add Contact
                                </button>
                            </div>
                        </div>
                    ...
                    <!-- Add Site Button -->
                    <button type="button" class="btn btn-sm btn-primary mb-3" id="add-site">
                        Add Another Site
                    </button>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="bill_type"
                                        id="bill_type_constant" value="constant" checked>
                    ...
                    <div id="variable-bill-table" class="mb-3" style="display: none;">
                        ...
                        <button type="button" class="btn btn-sm btn-secondary" id="add-bill-row">+ Add Bill
                            Row</button>
                    </div>
                    <div class="mb-3">
                        ...
                        <div id="engineer-container">
                            <div class="engineer-entry mb-3 p-3 border rounded">
                                <div class="row">
                                    <div class="col-md-3">
                                        <input type="text" class="form-control" name="engineers[0][name]"
                                            placeholder="Name" required>
                                    </div>
                                    <div class="col-md-3">
                                        <input type="text" class="form-control" name="engineers[0][organization]"
                                            placeholder="Organization">
                                    </div>
                                    <div class="col-md-3">
                                        <input type="tel" class="form-control" name="engineers[0][mobile]"
                                            placeholder="Mobile" required>
                                    </div>
                                    <div class="col-md-3">
                                        <input type="email" class="form-control" name="engineers[0][email]"
                                            placeholder="Email">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <button type="button" class="btn btn-sm btn-secondary" id="add-engineer">+ Add
                            Engineer</button>
                    </div>
                    <div class="mb-3">
                    ...
                    <table class="w-100 table-bordered" id="products-table">
                        <thead>
                            <tr>
                                <th>Item</th>
                                <th>Description</th>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <select class="form-select" name="products[0][item_id]" required>
                                ...
                                <td><input type="text" class="form-control" name="products[0][description]">
                                </td>
                                <td><input type="text" class="form-control" name="products[0][make]"></td>
                                <td><input type="text" class="form-control" name="products[0][model]">
                                </td>
                                <td><input type="text" class="form-control" name="products[0][serial_no]">
                                </td>
                    ...
                    <button type="button" class="btn btn-sm btn-secondary" id="add-product">+ Add
                        Product</button>
    ...
    <script>
        ...
        document.getElementById('add-site').addEventListener('click', function() {
            ...
            newSite.className = 'site-entry mb-4 border border-secondary p-3';
            newSite.innerHTML = `
            <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        document.getElementById('add-engineer').addEventListener('click', function() {
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <button type="button" class="btn btn-sm btn-danger mt-2 remove-engineer"><i class="fa fa-minus"></i></button>
                </div>
        ...
        document.getElementById('add-product').addEventListener('click', function() {
            ...
            <td><button type="button" class="btn btn-sm btn-danger remove-product"><i class="fa fa-minus"></i></button></td>
        `;
        ...
        document.getElementById('add-bill-row').addEventListener('click', function() {
            ...
            <td><button type="button" class="btn btn-sm btn-danger remove-bill-row"><i class="fa fa-minus"></i></button></td>
        `;
            tbody.appendChild(newRow);
            billCounter++;
        });
