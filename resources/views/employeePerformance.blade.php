            ...
            <div class="overall-summary mb-5">
                ...
                <table class="table-bordered w-50">
                    ...
                    <tr>
                        ...
                        <td class="p-2">
                            ₹{{ number_format($performanceData['overall_metrics']['total_emd_submitted'], 2) }}</td>
                    </tr>
                    <tr>
                        <th class="p-2">Total EMD Returned</th>
                        <td class="p-2">
                            ₹{{ number_format($performanceData['overall_metrics']['total_emd_returned'], 2) }}</td>
                    </tr>
                </table>
            </div>
