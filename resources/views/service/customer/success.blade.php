...
<head>
    ...
    <title>Complaint Submitted | Volks Energie</title>
        ...
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="https://volksenergie.in/">
                <img src="https://volksenergie.in/wp-content/uploads/2024/09/VE_Logo-Final-Black_BG_Artboard-1.png"
                    alt="Volks Energie Logo" width="150">
            </a>
        </div>
    </nav> --}}
    ...
    <div class="container my-5">
        <div class="card p-5 text-center">
            <div class="card-body">
                ...
                <h3 class="success-message">Your Complaint Has Been Submitted Successfully!</h3>
                <p class="mt-3">Thank you for reaching out to us. Our support team will review your complaint and get
                    back to you shortly.</p>
                <div class="mt-4">
                    <a href="/register-complaint" class="fw-bold text-decoration-underline">Register Another
                        Complaint</a>
                </div>
            </div>
        </div>
